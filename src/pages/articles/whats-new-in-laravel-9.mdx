...
Two new helpers have been added, making existing functionality easier to work with. The first of which makes building the already existing String class cleaner, acting as <span class="bg-snow-3 inline-block px-1 text-orange-500">Str::of</span>. The second new helper provides a simple way of creating a redirect response, based on the route name.
